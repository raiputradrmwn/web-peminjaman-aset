...
// // Interface untuk User (pending approval)
// interface User {
//   id: number;
//   name: string;
//   email: string;
...
// }: DashboardProps) {
//   const handleLogout = () => {
//     router.post("/logout"); // atau route("logout") kalau pakai Jetstream/Breeze
//   };
...
//       {/* Konten 2 kolom: Assets (kiri) + Approvals (kanan) */}
